...
# AgentAI-TOTEM
Desenvolvimento para um totem interativo com Inteligência Artificial da IA.Gora
...
CRIAR UMA BRANCH PARA TRABALHAR: Antes de fazer alterações, cada membro deve criar um branch para suas alterações. Isso ajuda a manter o histórico do projeto limpo e organizado.
...
+++ DIA-A-DIA: Antes de iniciar o trabalho diário em seu projeto, é importante garantir que você esteja trabalhando com a versão mais recente do código. Aqui está um passo a passo para atualizar seu projeto e continuar:
	...
	cd "/Users/karenota/Desktop/AgentAI-TOTEM”
